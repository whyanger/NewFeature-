...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	// 
	if(canShow){ // 初始化新特性界面
		self.window.rootViewController = [HYNewFeatureCtr newFeatureVCWithImageNames:@[@"load_1",@"load_2",@"load_3"]  dotImage:@"point_normal" currentDotImage:@"point_select" enterBlock:^{
			...
			[enterButton setBackgroundColor:COLOR_Theme];
