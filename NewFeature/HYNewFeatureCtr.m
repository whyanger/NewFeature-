...
- (UIButton *)vcPrepareDotImage:(NSString *)dotImage currentDotImage:(NSString *)currentDotImage{
	...
	//添加底部的圆点
	CGFloat pageOriginY = BWScreenHeight - 32;
	CGRect pageControlRect = CGRectMake(0, pageOriginY, BWScreenWidth, 20);
	
	//	self.pageControl
	_pageControl = [[HYPageControl alloc] initWithFrame:pageControlRect];
	_pageControl.backgroundColor = [UIColor clearColor];
	_pageControl.numberOfPages = _scrollView.contentSize.width / BWScreenWidth;
...
//	NSLog(@"%f",offset.x/bounds.size.width * 0.5);
